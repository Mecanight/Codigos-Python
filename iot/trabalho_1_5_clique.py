...
def consulta1():
    return [
    float((requests.get('https://api.thingspeak.com/channels/1928247/fields/1/last?key=G37I8C7N8N56H27S')).text),
    float((requests.get('https://api.thingspeak.com/channels/1928247/fields/2/last?key=G37I8C7N8N56H27S')).text),
    float((requests.get('https://api.thingspeak.com/channels/1928247/fields/3/last?key=G37I8C7N8N56H27S')).text),
    float((requests.get('https://api.thingspeak.com/channels/1928247/fields/4/last?key=G37I8C7N8N56H27S')).text)
    ]

def consulta2():
    return [
    float((requests.get('https://api.thingspeak.com/channels/1928249/fields/1/last?key=YK45KPNG2GOYJBTB')).text),
    float((requests.get('https://api.thingspeak.com/channels/1928249/fields/2/last?key=YK45KPNG2GOYJBTB')).text),
    float((requests.get('https://api.thingspeak.com/channels/1928249/fields/3/last?key=YK45KPNG2GOYJBTB')).text),
    float((requests.get('https://api.thingspeak.com/channels/1928249/fields/4/last?key=YK45KPNG2GOYJBTB')).text)
    ]

def consulta3():
    return [
    float((requests.get('https://api.thingspeak.com/channels/1928250/fields/1/last?key=MO1P1Q7MM9WXJTX4')).text),
    float((requests.get('https://api.thingspeak.com/channels/1928250/fields/2/last?key=MO1P1Q7MM9WXJTX4')).text),
    float((requests.get('https://api.thingspeak.com/channels/1928250/fields/3/last?key=MO1P1Q7MM9WXJTX4')).text),
    float((requests.get('https://api.thingspeak.com/channels/1928250/fields/4/last?key=MO1P1Q7MM9WXJTX4')).text)
    ]
